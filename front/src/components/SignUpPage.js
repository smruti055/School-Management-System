            ...
            <div className="w-full  shadow border max-w-md bg-gray-900 border-gray-700">
                <div className="p-6 space-y-6">
                    ...
                    <form className="space-y-6" action="post">
                        ...
                        <button type="submit" onClick={registerHandle} className="w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-primary-700 focus:ring-primary-800">CREATE ACCOUNT</button>
