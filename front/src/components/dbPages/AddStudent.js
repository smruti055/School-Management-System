...
const AddStudent = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        axios.post('http://localhost:8080/add_student', newStudent)
        .then(res => {
    ...
    <section className="bg-gray-900">
        <div className="px-6 mx-auto h-screen pt-6">
            ...
            <div className="flex flex-col items-center justify-center mx-auto pt-6">
                ...
                <div className="w-full shadow border max-w-md bg-gray-800 border-gray-700">
                    <div className="p-6 space-y-6">
                        <form className="space-y-6" action="post">
                            <div className='flex justify-between'>
                                <div className='w-full mr-4'>
                                    <label for="name" className="block mb-2 text-sm font-medium text-white">Student's Name</label>
                                ...
                                <div className='w-full ml-4'>
                                    <label for="fname" className="block mb-2 text-sm font-medium text-white">Father's Name</label>
                            ...
                            <div className='flex justify-between'>
                                <div className='w-full mr-4'>
                                    <label for="roll" className="block mb-2 text-sm font-medium text-white">Roll Number</label>
                                ...
                                <div className='w-full ml-4'>
                                    <label for="classs" className="block mb-2 text-sm font-medium text-white">Branch</label>
                                    <input type="text" name="classs" value={newStudent.classs} onChange={changeHandler} id="classs" className="border text-sm rounded-lg focus:ring-primary-600 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" required="" />
                                </div>
                            </div>
                            <div>
                                <label for="phnum" className="block mb-2 text-sm font-medium text-white">Phone Number</label>
                            ...
                            <div>
                                <label for="addresss" className="block mb-2 text-sm font-medium text-white">Address</label>
                            ...
                            <div className='flex justify-between'>
                                <button onClick={handleSubmit} type="submit" className="mr-4 w-full text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-primary-700 focus:ring-primary-800">Add</button>
